            ...
            if event_label_data is None:
                ...
                if event_label_option:
                    ...
                    if combined_data is None:
                        ...
                        ax.set_title(f'Active Principal (Below x-axis) & Potential Payout (above x-axis) by ParticipantName for {event_type_option} - {event_label_option} (GA1, Straight Bets Only)', fontsize=18, fontweight='bold')
